    ...
    <main class="main">
        ...
        <section class="home section" id="home">
            <div class="home_container container grid">
                <div class="home_img">
                    <img src=" 
                {{ isset($about->home_image)?  asset('storage/images/'.$about->home_image): asset('storage/images/avatar.jpg') }}" alt="">
                </div>
                ...
                <div class="swiper-wrapper">
                    ...
                    <div class="testimonial_content swiper-slide">
                        ...
                        <p class="testimonial_description">
                            I had a great experience; my project was handled with excellent quality, care, and 24/7 support.
                        </p>
        ...
        <section class="contact section" id="contact">
            ...
            <span class="section__subtitle"> {{ $about->phone }} </span>
                ...
                <div>
                    ...
                    <div class="contact_information">
                        ...
                        <div>
                            ...
                            <span class="contact_subtitle">bafoussam</span>
                        </div>
                    </div>
                </div>
